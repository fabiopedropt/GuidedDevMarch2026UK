	...
	public class UsrYachtEventsSchema : Terrasoft.Core.SourceCodeSchema
	{
		...
		protected virtual SchemaLocalizableString CreateValueIsTooBigLocalizableString() {
			SchemaLocalizableString localizableString = new SchemaLocalizableString() {
				UId = new Guid("8094af77-6536-f6e2-4d53-9e3100586a42"),
				Name = "ValueIsTooBig",
				CreatedInPackageId = new Guid("b480aec7-adf1-4d79-bec4-58483ff778e8"),
				CreatedInSchemaUId = new Guid("14725817-20ad-4dbc-adea-6d07f94080dd"),
				ModifiedInSchemaUId = new Guid("14725817-20ad-4dbc-adea-6d07f94080dd")
			};
		...
		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			...
			realUIds.Add(new Guid("14725817-20ad-4dbc-adea-6d07f94080dd"));
		}
